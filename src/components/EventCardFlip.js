    ...
    <ReactCardFlip isFlipped={flip} flipDirection="vertical" key={props.key}>
        ...
        <Grid container spacing={5}>
            ...
            >
                ...
                spacing={1}
                >
                <Typography color="text.secondary">{props.dateWeekday}</Typography>
                <Typography
                ...
                <Typography color="text.secondary">{props.dateMonth}, {props.dateYear}</Typography>
                </Stack>
            </Paper>
            </Grid>
            ...
            <Grid item xs container direction="column" spacing={2}>
                ...
                <Typography variant="body1">Time: {props.dateTimeStart} - {props.dateTimeEnd} {props.dateTimezone}</Typography>
                </Grid>
                <Grid item>
        ...
        >
            `<Stack>
                ...
                Time: {props.dateTimeStart} - {props.dateTimeEnd} {props.dateTimezone}
                </Typography>
